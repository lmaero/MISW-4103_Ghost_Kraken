...
(async () => {
  ...
  for (const browserType of ["chromium"]) {
    ...
    await page.screenshot({ path: "./prueba2.0.1.png" });
    ...
    await page.screenshot({ path: "./prueba2.1.1.png" });
    ...
    await page.screenshot({ path: "./prueba2.2.1.png" });
    ...
    await page.screenshot({ path: "./prueba2.3.1.png" });

    await page.click('a[href="#/tags/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba2.4.1.png" });

    await page.click('a[href="#/tags/prueba/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba2.5.1.png" });

    await page.type('textarea[id="tag-description"]', "Descripcion de prueba");

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba2.6.1.png" });
    ...
    await page.screenshot({ path: "./prueba2.7.1.png" });
