...
(async () => {
  ...
  for (const browserType of ["chromium"]) {
    ...
    await page.screenshot({ path: "./prueba3.0.1.png" });
    ...
    await page.screenshot({ path: "./prueba3.1.1.png" });
    ...
    await page.screenshot({ path: "./prueba3.2.1.png" });
    ...
    await page.screenshot({ path: "./prueba3.3.1.png" });

    await page.click('a[href="#/tags/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba3.4.1.png" });

    await page.click('a[href="#/tags/prueba/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba3.5.1.png" });

    await page.click('button[class="gh-btn gh-btn-red gh-btn-icon mb15"]');

    await new Promise((r) => setTimeout(r, 1000));

    await page.screenshot({ path: "./prueba3.6.1.png" });
    ...
    await page.screenshot({ path: "./prueba3.7.1.png" });

    await page.click('a[href="#/tags/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba3.8.1.png" });
