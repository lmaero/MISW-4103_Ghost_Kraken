...
(async () => {
  ...
  for (const browserType of ["chromium"]) {
    ...
    await page.screenshot({ path: "./prueba5.0.1.png" });
    ...
    await page.screenshot({ path: "./prueba5.1.1.png" });
    ...
    await page.screenshot({ path: "./prueba5.2.1.png" });
    ...
    await page.screenshot({ path: "./prueba5.3.1.png" });

    await page.click('a[href="#/staff/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba5.4.1.png" });

    await page.screenshot({ path: "./prueba5.5.1.png" });

    await page.click('a[href="#revoke"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba5.6.1.png" });
