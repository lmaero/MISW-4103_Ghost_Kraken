...
(async () => {
  ...
  for (const browserType of ["chromium"]) {
    ...
    await page.screenshot({ path: "./prueba5.0.2.png" });
    ...
    await page.screenshot({ path: "./prueba5.1.2.png" });
    ...
    await page.screenshot({ path: "./prueba5.2.2.png" });
    ...
    await page.screenshot({ path: "./prueba5.3.2.png" });

    await page.click('a[href="#/settings/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba5.4.2.png" });

    await page.click('a[href="#/settings/staff/"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba5.5.2.png" });

    await page.click('a[href="#revoke"]');

    await new Promise((r) => setTimeout(r, 3000));

    await page.screenshot({ path: "./prueba5.6.2.png" });
