...
describe("Feature: Settings Ghost 4.44.0", () => {
  ...
  it("should be change the blog name and description",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div[2]/section/div[1]/div[1]/button');
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div[1]/header/section/button');
  });
  ...
  it("should be add new submenu item in navbar",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div/header/section/button');
  });
  ...
  it("should be change the social networks url's",  () => {
    ...
    // And I click in "Expand"
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div[3]/section/div[4]/div[1]/button');
  ...
  it("should be disable AMP integration",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/section/div/section/div/div/div[1]/div[2]/div/label/span');
