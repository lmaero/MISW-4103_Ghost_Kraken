...
describe(`c1_edit_blog_title`, function () {
    it(`should be edited blog name [allowed length][(II) Dynamic Random Datapool]`, function () {
      ...
      cy.wait(2000);
      cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[2]/button')
        .click();
      cy.wait(2000);
      cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[1]/div[3]/div/div/div[1]/input')
        .clear()
    ...
    it(`should be not edited blog name [not allowed length][(III) Random escenario]`, function () {
      ...
      cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[1]/div[3]/div/div/div[1]/input')
        .clear()
        .type(faker.lorem.sentence(100), { force: true })
      cy.wait(2000);
      cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
        .click()
      cy.wait(500);
...
describe(`c2_edit_blog_description`, function () {
  it(`should be edited blog description [allowed length][(I) A priori Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[1]/div[3]/div/div/div[2]/input')
      .clear()
  ...
  it(`should be not edited blog description [not allowed length][(II) Dynamic Random Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[1]/div[3]/div/div/div[2]/input')
      .clear()
      .type(register.invalid_blog_description, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    cy.wait(500);
...
describe(`c3_edit_blog_meta_title`, function () {
  it(`should be edited blog meta title [allowed length][(III) Random escenario]`, function () {
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[2]/div/div/div/div[1]/div[1]/input')
      .clear()
  ...
  it(`should be not edited blog meta title [not allowed length][(I) A priori Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[2]/div/div/div/div[1]/div[1]/input')
      .clear()
      .type(register.invalid_blog_meta_title, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
...
describe(`c4_edit_blog_meta_description`, function () {
  it(`should be edited blog meta description [allowed length][(II) Dynamic Random Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[2]/div/div/div/div[1]/div[2]/textarea')
      .clear()
  ...
  it(`should be not edited blog meta description [not allowed length][(I) A priori Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[1]/div[2]/div/div/div/div[1]/div[2]/textarea')
      .clear()
      .type(register.invalid_blog_meta_description, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    // Error del request manejado
...
describe(`c5_edit_blog_twitter_card_title`, function () {
  it(`should be edited blog twitter card title [allowed length][(II) Dynamic Random Datapool]`, function () {
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[2]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[2]/div[2]/div/div/div/div[1]/div[2]/input')
      .clear()
...
describe(`c6_edit_blog_twitter_card_description`, function () {
  it(`should be edited blog twitter card description [allowed length][(III) Random escenario]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[2]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[2]/div[2]/div/div/div/div[1]/div[3]/textarea')
      .clear()
      .type(faker.lorem.sentence(10), { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
  ...
  it(`should be not edited blog twitter card description [not allowed length][(I) A priori Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[2]/div[2]/div/div/div/div[1]/div[3]/textarea')
      .clear()
      .type(register.invalid_blog_twitter_card_description, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    // Error del request manejado
...
describe(`c7_edit_blog_facebook_card_title`, function () {
  it(`should be edited blog twitter card title [allowed length][(I) A priori Datapool]`, function () {
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[3]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[3]/div[2]/div/div/div/div[1]/div[2]/input')
      .clear()
  ...
  it(`should be not edited blog twitter card title [not allowed length][(II) Dynamic Random Datapool]]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[3]/div[2]/div/div/div/div[1]/div[2]/input')
      .clear()
      .type(register.invalid_blog_facebook_card_title, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    // Error del request manejado
...
describe(`c8_edit_blog_facebook_card_description`, function () {
  it(`should be edited blog facebook card description [allowed length][(II) Dynamic Random Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[3]/div[1]/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[6]/div[3]/div[2]/div/div/div/div[1]/div[3]/textarea')
      .clear()
...
describe(`c9_edit_blog_facebook_social_account_url`, function () {
  it(`should be edited blog facebook url [valid url][(I) A priori Datapool]`, function () {
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[1]/div[3]/div/div/div[1]/input')
      .clear()
  ...
  it(`should be edited blog facebook url [invalid url][(III) Random escenario]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[1]/div[3]/div/div/div[1]/input')
      .clear()
      .type(`${faker.internet.url()}/${faker.internet.userName()}`, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    cy.wait(500);
...
describe(`c10_edit_blog_twitter_social_account_url`, function () {
  it(`should be edited blog twitter url [valid url][(III) Random escenario`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[2]/button')
      .click();
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[1]/div[3]/div/div/div[2]/input')
      .clear()
      .type(`${faker.internet.protocol()}://www.twitter.com/${faker.internet.userName()}`, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    cy.wait(500);
  ...
  it(`should be edited blog twitter url [invalid url][(II) Dynamic Random Datapool]`, function () {
    ...
    cy.xpath('/html/body/div[2]/div/main/section/div/section/div[8]/div/div[1]/div[3]/div/div/div[2]/input')
      .clear()
      .type(register.invalid_twitter_url, { force: true })
    cy.wait(2000);
    cy.xpath('/html/body/div[2]/div/main/section/div/header/section/button')
      .click()
    cy.wait(500);
