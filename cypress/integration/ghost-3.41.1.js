...
describe("Feature: Settings Ghost 3.41.1", () => {
  ...
  it("should be change the blog name and description",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div/section/div[2]/div[1]/div[2]/button');
  ...
  it("should be add new submenu item in navbar",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/header/section/button');
  });
  ...
  it("should be change the social networks url's",  () => {
    ...
    // And I click in "Expand"
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/div/section/div[8]/div/div[2]/button');
  ...
  it("should be disable AMP integration",  () => {
    ...
    Actions.getXPathAndClick('//html/body/div[2]/div/main/section/section/div[2]/div[1]/div[2]/div/label/span');
