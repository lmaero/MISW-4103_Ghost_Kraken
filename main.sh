...
function randomMonkey() {
  npx cypress run --headless --config video=false --config-file "monkey-config.json" --spec "cypress/integration/semana4/monkey.js"
}

function smartMonkey() {
  npx cypress run --headless --config video=false --config-file "smart-monkey-config.json" --spec "cypress/integration/semana4/smart-monkey.js"
}
